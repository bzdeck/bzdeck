...
// This code supports both POST and GET for backward compatibility.
  ...
  <body>
    <script type="application/javascript;version=1.8">
      window.addEventListener('DOMContentLoaded', event => {
        ...
        // Otherwise, notify the credentials to the main winow over a BroadcastChannel and close this sub window.
