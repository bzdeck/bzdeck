 ...
 */
BzDeck.views.ProfilePage.prototype.on_gravatar_profile_found = function (data) {
  if (!this.$header) {
    return false;
  }
 ...
 * @return {Boolean} result - Whether the view is updated.
 */
BzDeck.views.ProfilePage.prototype.on_bugzilla_profile_found = function (data) {
 ...
 * @return {Boolean} result - Whether the view is updated.
 */
BzDeck.views.ProfilePage.prototype.on_bugzilla_profile_fetching_error = function (data) {
  if (!this.$status) {
    return false;
  }
 ...
 * @return {Boolean} result - Whether the view is updated.
 */
BzDeck.views.ProfilePage.prototype.on_bugzilla_profile_fetching_complete = function () {
